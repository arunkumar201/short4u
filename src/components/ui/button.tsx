...
> = forwardRef<HTMLAnchorElement | HTMLButtonElement, ButtonProps>(
    function Button(props: ButtonProps, forwardedRef) {
        ...
        const element: T = React.createElement(
            elementType,
            {
                ...passThroughProps,
                disabled,
                ...
                className: cn(
                    ...
                    size === 'lg' &&
                        'px-8 py-4 text-base font-medium rounded-md',
                    size === 'icon' &&
                    ...
                    variant === 'primary' &&
                        (disabled
                            ? 'border border-transparent bg-slate-400 text-white'
                            : 'bg-primary text-primary-foreground hover:bg-primary/90  focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-slate-900'),
                    ...
                    variant === 'secondary' &&
                        (disabled
                            ...
                            : 'bg-secondary text-secondary-foreground hover:bg-secondary/80 focus:outline-none focus:ring-2 focus:ring-offset-1  focus:bg-slate-300 focus:ring-neutral-500'),
                    variant === 'warn' &&
                        (disabled
