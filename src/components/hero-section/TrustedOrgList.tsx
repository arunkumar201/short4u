...
export function TrustedOrgList() {
    return (
        <section className="w-full relative py-6 md:py-8 bg-slate-300 dark:bg-primary/60 mt-4 rounded-2xl text-center flex justify-center items-center shadow-inner shadow-teal-300 dark:shadow-[#FFD700]">
